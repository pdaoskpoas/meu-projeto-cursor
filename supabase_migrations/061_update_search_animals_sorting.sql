-- =====================================================
-- MIGRATION 061: Ajustar ordenação da função search_animals
-- Data: 15/11/2025
-- Objetivo: alinhar filtros "Mais relevantes", "Mais recentes" e
--           "Mais visualizados" aos requisitos do front.
-- =====================================================

-- Remover função anterior (mesma assinatura)
