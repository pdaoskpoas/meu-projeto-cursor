-- =====================================================
-- Migration 035: Views de Analytics para Eventos
-- Descrição: Criar views para agregar estatísticas de eventos
-- Data: 2025-11-03
-- =====================================================

-- =====================================================
-- VIEW: events_with_stats
-- Descrição: Eventos com contadores de impressões e cliques
-- =====================================================
...
-- Comentário
COMMENT ON VIEW events_with_stats IS 'Eventos com estatísticas de impressões e cliques agregadas';
...
DO $$
BEGIN
  RAISE NOTICE '✅ Migration 035: Views de analytics para eventos criadas com sucesso';
END $$;
